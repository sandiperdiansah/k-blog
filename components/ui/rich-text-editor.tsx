...
const toolbarStylesMap: Record<RichTextEditorToolbarVariant, SystemStyleObject> = {
    sticky: {
        bg: "bg",
        position: "sticky",
...
export const RichTextEditorFooter = React.forwardRef<HTMLDivElement, StackProps>(
